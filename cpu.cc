 ...
 * The result of lzcnt is 31 minus the result of the bsr (bit scan reverse), except when the input is 0
 *
...
char x86_cpu_vendor[13];
x86_cpuid_info x86_cpuid_h0;
x86_cpuid_info x86_cpuid_h1;
x86_cpuid_info x86_cpuid_h7_c0;
x86_cpuid_info x86_cpuid_h80000001;
std::map<std::string,uint32_t> x86_caps;
